...
global gacc1 = ParallelAccumulator(+, 0)
global gacc2 = ParallelAccumulator(*, 1)
global gval = 1
function foo()
    local lval = 2
    local l1 = ParallelAccumulator(string, "");
...
@test take!(ParallelAccumulator(+, 0)) == 0
@test take!(ParallelAccumulator(+, 0)) == 0
